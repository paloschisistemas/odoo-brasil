...
def _convert_values(vals):
    ...
    for rps in vals:
        ...
        rps["prestador"]["inscricao_municipal"] = re.sub(
            "\W+", "", rps["emissor"]["inscricao_municipal"]
        )
        ...
        # Tomador
        rps["tomador"].update(rps["tomador"]["endereco"])
        ...
        rps["codigo_tributacao_municipio"] = rps["itens_servico"][0][
