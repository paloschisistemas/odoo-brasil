...
class StockPicking(models.Model):
    ...
    invoice_count = fields.Integer(string="Invoices", compute="_compute_invoices")
    ...
    def _prepare_invoice_values(self):
        ...
        vals = {
            ...
            "invoice_payment_term_id": picking_id.partner_id.property_payment_term_id.id,
            "fiscal_position_id": picking_id.partner_id.property_account_position_id.id,
